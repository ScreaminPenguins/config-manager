...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info $light_blue $thm_bg"
		# "hostname $thm_bg $blue_1"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"date_day 235 $light_blue"
		"date 235 $light_blue ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 235 $light_blue ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
